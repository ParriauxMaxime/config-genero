      ...
      return {
        ...
        _apply: function(controller, data) {
          ...
          if (widget && widget.setHtmlControl) {
            ...
            if (format === "html") {
              if (controller._widgetType === "TextEdit" && controller.getAnchorNode().attribute("dialogType") === "Input") {
                return controller.changeWidgetKind("RichText"); //return true to invalidate following behaviors
              } else {
