...
modulum('DateTimeEditController', ['TextValueContainerControllerBase', 'ControllerFactory'],
  /**
   * @param {gbc} context
   * @param {classes} cls
   */
  function(context, cls) {
     ...
     */
    cls.DateTimeEditController = context.oo.Class(cls.TextValueContainerControllerBase, function($super) {
      ...
      return {
        ...
        _initBehaviors: function() {
          ...
          // ui behaviors
          this._addBehavior(cls.SendDateTimeValueUIBehavior);
