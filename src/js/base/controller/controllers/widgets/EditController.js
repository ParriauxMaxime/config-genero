...
modulum('EditController', ['TextValueContainerControllerBase', 'ControllerFactory'],
  /**
   * @param {gbc} context
   * @param {classes} cls
   */
  function(context, cls) {
     ...
     */
    cls.EditController = context.oo.Class(cls.TextValueContainerControllerBase, function($super) {
      /** @lends classes.EditController.prototype */
      return {
        __name: "EditController",

        /**
         * @constructs {classes.EditController}
