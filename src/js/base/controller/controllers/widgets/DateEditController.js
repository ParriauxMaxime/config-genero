...
modulum('DateEditController', ['TextValueContainerControllerBase', 'ControllerFactory'],
  /**
   * @param {gbc} context
   * @param {classes} cls
   */
  function(context, cls) {
     ...
     */
    cls.DateEditController = context.oo.Class(cls.TextValueContainerControllerBase, function($super) {
